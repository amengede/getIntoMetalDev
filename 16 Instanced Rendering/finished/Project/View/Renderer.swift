...
class Renderer: NSObject, MTKViewDelegate {
    ...
    init(_ parent: ContentView, scene: GameScene) {
        ...
        materialLump.consume(material: artyMaterial.texture, layer: OBJECT_TYPE_CUBE)
        materialLump.consume(material: woodMaterial.texture, layer: OBJECT_TYPE_GROUND)
        materialLump.consume(material: mouseMaterial.texture, layer: OBJECT_TYPE_MOUSE)
        materialLump.consume(material: lightMaterial.texture, layer: OBJECT_TYPE_POINT_LIGHT)
